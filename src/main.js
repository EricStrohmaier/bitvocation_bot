...
import { createUserEntry, deleteJobAlerts, formatVariables, getKeyword, getLatestJobs, getUserConfigs, hasJobAlert, readUserEntry, sendParseMessage, updateJobAlerts, } from './functions.js';
...
bot.on('message', async (msg) => {
    ...
    if (setJobAlert && ((_a = msg.text) === null || _a === void 0 ? void 0 : _a.startsWith('/'))) {
        setJobAlert = false;
